...
public:
	...
	void compute(const Mat & leftImage,
				 const Mat & dispInput,
				 float * disparityImage);

private:
	void initialize(const Mat & leftImage, const Mat & rightImage);
	void setImageSize(const Mat & leftImage, const Mat & dispInput);
	void allocateDataBuffer();
	void freeDataBuffer();
	void computeCostImage(const Mat & leftImage, const Mat & rightImage);
	void convertToGrayscale(const Mat & leftImage,
